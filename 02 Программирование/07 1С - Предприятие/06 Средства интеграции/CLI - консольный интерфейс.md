...
Открытие клиентского приложения (севрерная база) с последующим выполнением обработки

```batch
..\1cestart.exe ENTERPRISE /S {<ИмяСервераПриложений>\<ИмяБазыДанных>} /N ИмяПользователя /P Пароль /Execute <путьКВнешнейОбработке>
```
