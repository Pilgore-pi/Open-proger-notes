...
Так как роутер излучает радиоволны, то возникает проблема наложения волн с другими радиоволнами, источниками которых, например, могут быть сотовые телефоны, рации, радиостанции, вышки и другие точки доступа Wi-Fi. Одним из главных способов решения данной проблемы является ограничение диапазона частоты сигналов Wi-Fi, что обосабливает Wi-Fi сети от других типов сетей
...
Каждый из диапазонов разделен на **каналы**, узкие диапазоны частот, на которых может работать Wi-Fi
...
| WAPI       | SMS4                | безопасен (локальный китайский стандарт) |
