...
/*option*/
tp-yt-paper-listbox {
    background: linear-gradient(180deg, #520d69 0%, #ff00b285 100%), url(https://img1.wallspic.com/crops/2/1/8/5/6/165812/165812-atmosphere-geometry-mathematics-purple-violet-2560x1440.jpg) center center/cover no-repeat fixed #3a0e59!important
}
...
ytd-comment-action-buttons-renderer.ytd-backstage-post-renderer ytd-button-renderer.ytd-comment-action-buttons-renderer[is-icon-button].style-default-active.ytd-comment-action-buttons-renderer,
ytd-comment-action-buttons-renderer.ytd-backstage-post-renderer ytd-toggle-button-renderer.ytd-comment-action-buttons-renderer[is-icon-button].style-default-active.ytd-comment-action-buttons-renderer {
    color: #00b9f8;
}
...
tp-yt-app-drawer[opened] [class="style-scope ytd-logo"][id="logo-icon"] {
    ...
    fill-opacity: 0;
    background: url("https://i.ibb.co/rxhXqHs/neonyt.png") center center/100% no-repeat;
    max-width: 70px;
    max-height: 100px;
}
...
@keyframes none
{
    ...
    100% {
        filter: hue-rotate(360deg) saturate(6.1);
    }
}
...
@keyframes yadpogi
{
    ...
    40% {
        background-color: #fff;
        box-shadow: 0 0 9px 3px #00ffc3;
    }
    50% {
        background-color: #fff;
        box-shadow: 0 0 7px 3px #b3ff00;
    }
    60% {
        background-color: #fff;
        box-shadow: 0 0 9px 3px #ff8400;
    }
    70% {
        background-color: #fff;
        box-shadow: 0 0 7px 3px #ff6a00;
    }
    80% {
        background-color: #fff;
...
ytd-app {
    background-image: url(https://i.postimg.cc/J4gFh3TK/sunset.gif),
                      url(https://i.postimg.cc/1mScS4XW/retrowave.png)!important;
    background-repeat: no-repeat!important;
    background-attachment: fixed;
    background-color: #14031e!important;
...
ytd-app[darker-dark-theme],
ytd-app {
    background-image: url(https://dummy), url(https://img1.wallspic.com/crops/2/1/8/5/6/165812/165812-atmosphere-geometry-mathematics-purple-violet-2560x1440.jpg)!important;
}
...
ytd-searchbox[desktop-search-bar-big-tap-target] #search-icon-legacy.ytd-searchbox:hover {
    border: 1px solid #5e2288d4;
...
ytd-searchbox[desktop-searchbar-style=rounded_corner_dark_btn] #container.ytd-searchbox, ytd-searchbox[desktop-searchbar-style=rounded_corner_light_btn] #container.ytd-searchbox {
background: #00000070;
}
ytd-searchbox[has-focus][desktop-searchbar-style=rounded_corner_dark_btn] #container.ytd-searchbox, ytd-searchbox[has-focus][desktop-searchbar-style=rounded_corner_light_btn] #container.ytd-searchbox,
...
@keyframes yadsearch {
    0% {
        box-shadow: inset 0 0px 9px 12px #f0f
    }
}
...
ytd-multi-page-menu-renderer[darker-dark-theme] {
    /*right dropdown notif*/
    border-radius: 10px;
    background: linear-gradient(180deg, #520d69 0%, #ff00b266 100%), url(https://img1.wallspic.com/crops/2/1/8/5/6/165812/165812-atmosphere-geometry-mathematics-purple-violet-2560x1440.jpg) center center/cover no-repeat fixed #30083bed;
    box-shadow: 0px 0px 5px 1px #00000094, 0px 0px 0px 1px #b84fff
}
...
.ytp-volume-slider-handle {
    ...
    margin-top: -6px;
    background: #ffffff;
    box-shadow: 0 0 12px 5px #2de2e6;
}
...
@keyframes yadlive {
    0% {
        background-color: #fff0;
        box-shadow: inset 0 0 9px 3px #ff00d4;
    }
    10% {
        background-color: #fff0;
        box-shadow: inset 0 0 7px 3px #9d00ff;
    }
    20% {
        background-color: #fff0;
        box-shadow: inset 0 0 9px 3px #fff;
    }
    30% {
        background-color: #fff0;
        box-shadow: inset 0 0 7px 3px #00d9ff;
    }
    40% {
        background-color: #fff0;
        box-shadow: inset 0 0 9px 3px #00ffc3;
    }
    50% {
        background-color: #fff0;
    ...
    60% {
        background-color: #fff0;
        box-shadow: inset 0 0 9px 3px #ff00e1;
    }
    70% {
        background-color: #fff0;
        box-shadow: inset 0 0 7px 3px #fff;
    ...
    80% {
        background-color: #fff0;
        box-shadow: inset 0 0 9px 3px #00ffea;
    }
    90% {
        background-color: #fff0;
        box-shadow: inset 0 0 7px 3px #bdff00;
    }
    100% {
        background-color: #fff0;
        box-shadow: inset 0 0 7px 3px #ff00d4;
    }
}
...
#progress.ytd-thumbnail-overlay-resume-playback-renderer[style*="100%"]::before {
    ...
    background: linear-gradient(-90deg, #0000 10%, #7608a4 100%);
...
/*mic*/
[d*="41V21h2v-2.59c3.11-.48 5.5-3.17 5.5-6.41z"],
...
[d*="M17,18v1H6V18ZM6.49,9l.71.71L11,5.91V16h1V5"],
path[d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2z"],
[d*="M14,13h-3v3H9v-3H6v-2h3V8h2v3h3V13z M17,6H3"] {
...
/*bell*/
[d^="m13.497 4.898.053.8.694.4C15.596 6.878 16.5 8.334 16.5 10v2.892c0"],
[d^="M18.001 10a6.003 6.003 0 00-4.025-5.667 2 2 0 10-3.945-.002A6.003 6.003"],
[d*="M10 20h4c0 1.1-.9 2-2 2s-2-.9-2-2zm10-2.65V19H4"],

path[d*="42-2-1.88v-5.47c0-2.47-1.19-4.36-3.13-5.1-1.26-.53-2.64-.5-3.84.03C8.15 6.11 7 7.99 7 10.42v5.47l-2 1.88V18h14v-.23z"],
[d*="M10,20h4c0,1.1-0.9,2-2,2S10,21.1,10,20z M20"] {
...
@keyframes yadix {
    0% {
        box-shadow: 0px 0px 9px 4px #f40a8f;
        border-radius: 50px;
        color: #ff00ae;
    }
}
...
content: url(https://www.gstatic.com/youtube/img/creator/yt_studio_logo_white.svg);
}
...
html[system-icons] {
--yt-spec-base-background: #2c0d3b;
    --ytcp-video-row-highlighted: #0dffff26;
    --ytcp-brand-background-solid:linear-gradient(-90deg, #520d693d 0%, #ff00b240 100%);
    ...
    --ytd-searchbox-legacy-border-shadow-color: #0006;
    --yt-spec-brand-background-solid: #f5151500;
    ...
    --yt-spec-general-background-c: #df1e1e00;
    --yt-spec-call-to-action: #00fff7;
    --ytd-searchbox-text-color: #fff;
    /*studio*/
    --ytcp-hover-item: #0dffff26;
    --ytcp-selected-item: #ff00b27d;
    --ytcp-general-background-a: #00000094;
    --ytcp-text-primary: #fff;
    --ytcp-text-secondary: #bebebe;
    --ytmusic-nav-bar: linear-gradient(-90deg, #520d693d 0%, #ff00b240 100%);
    --ytmusic-player-page-background: linear-gradient(-90deg, #520d693d 0%, #ff00b240 100%);
}
#cinematics {
...
/********************************/body {
    ...
    #player-bar-background.ytmusic-app-layout {
        background:linear-gradient(-90deg, #520d696e 0%, #ff00b240 100%)
    }
