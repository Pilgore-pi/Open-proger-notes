> **MVVM (Model-View-ViewModel)** — шаблон проектирования многоуровневой архитектуры приложения из семейства MV-паттернов, который заключается в разделении логики программы и ее интерфейса.  Суть паттерна состоит в разделении MVVM принадлежит семейству MV-паттернов и . Другие MV-паттерны: MVC, HMVC, MVP. Платформы ориентированные под паттерн MVVM: WPF, Avalonia, UWP, Xamarin, MAUI.
