...
Назад: [JOIN - Соединения таблиц](06%20JOIN%20-%20Соединения%20таблиц.md)

Далее: [UPDATE - изменение данных](08%20UPDATE%20-%20Изменение%20данных.md)

Для удаления записей применяется команда `DELETE`:
