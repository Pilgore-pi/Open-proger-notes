...
После вызова асинхронного метода управление вернется к коду, вызвавшему этот метод, не дожидаясь, когда асинхронный метод завершит свою работу. Когда вызванный асинхронный метод отработает, он оповестит о своем завершении и предоставит доступ к результату.
