...
| Больший контроль над процессором и памятью                                | **Меньшая гибкость**. Изменения в коде требуют пересборки всего проекта или его части, что делает быстрые эксперименты менее удобными |
...
|                                                     | комментарии в коде могут замедлить исполнение               |
