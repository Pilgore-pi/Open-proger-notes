...
1) Прикладной — самый высокий уровень, уровень прикладных программ, с которыми работают пользователи. В качестве прикладных программам могут выступать: браузер, почтовый клиент, 
