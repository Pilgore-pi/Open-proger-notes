...
> В C\# условные операторы `if-else` и `switch-case` являются **операторами**, а не выражениями, а тернарный условный оператор и оператор сопоставления шаблонов `switch` являются **выражениями**, возвращающими какое-то значение
