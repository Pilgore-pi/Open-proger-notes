...
Макетом представлен документом Word. Данный подход формирует печатную форму и сохраняет ее в документ .docx
...
Функция НапечататьДокумент(МассивОбъектов)
    ...
    ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъектов(МассивОбъектов, "<перечисление нужных реквизитов через запятую>, Ссылка");
    
    Для каждого ссылка из МассивОбъектов Цикл
        
        реквизитыДока = ЗначенияРеквизитов[Ссылка];
        реквизитыДока.Дата = Формат(РеквизитыДокумента.Дата, "ДЛФ=D");
        реквизитыДока.Номер = ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(РеквизитыДокумента.Номер);
        
        ИмяДокумента = СтроковыеФункцииКлиентСервер.ВставитьПараметрыВСтроку(Шаблон, реквизитыДока);
...
Функция СформироватьДокумент(Ссылка)
    ...
    МакетДокумента = УправлениеПечатью.МакетПечатнойФормы("Документ.МойДокумент.ИдентификаторПечатнойФормы");
