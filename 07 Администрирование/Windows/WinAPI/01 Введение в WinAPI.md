...
> **WinApi** — это программный интерфейс операционных систем семейства Windows, который содержит огромное количество процедур и функций, позволяющих взаимодействовать с компонентами операционной системы, такими как окна, файлы, сеть, реестр и другие системные ресурсы
