...
| Флаг `CWR`                  |                |                                                                                                                                                                   |
| Флаг `ECE`                  |                |                                                                                                                                                                   |
| Флаг `UGR`                  |                | Определеяет, содержит ли сегмент срочные данные, необходимые программе                                                                                            |
| Флаг `ACK`                  |                |                                                                                                                                                                   |
| Флаг `PSH`                  |                |                                                                                                                                                                   |
| Флаг `RST`                  |                |                                                                                                                                                                   |
| Флаг `SYN`                  |                |                                                                                                                                                                   |
...
| (Необязательные параметры)  | ?              | Часть заголовка с неизвестной длиной. Информация о размере заголовка храниться в                                                                                  |
