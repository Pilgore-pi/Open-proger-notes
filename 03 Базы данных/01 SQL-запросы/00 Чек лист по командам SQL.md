...
- [ ] Получить все записи первой таблицы и добавить к ним все записи второй таблицы (сопоставить столбцы обеих таблиц). Можно использовать одну и ту же таблицу, но 2 запроса, которые получают разные части таблицы (например, строки с 1 по 15 и с 20 по 30)
...
- [ ] Вставить 3 записи в таблицу. Для каждого поля указать значения вручную. Таблица должна содержать поле типа "Дата", заполнить это поле текущей датой
