В самых распространенных IDE можно создать проекты на основе **шаблонов**. Шаблоны не влияют на функциональные возможности программы, они используются как заготовка кода и структуры проекта.
