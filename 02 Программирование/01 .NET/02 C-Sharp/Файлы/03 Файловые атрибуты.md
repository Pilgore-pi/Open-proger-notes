...
| `Temporary`         | (нет)       |                    | **Временный файл**, предполагается быстрое удаление.                                                                           | Windows                                                 |
| `Compressed`        | (нет)       |                    | **Сжатый файл** ФС `NTFS`                                                                                                      | Windows                                                 |
| `Encrypted`         | (нет)       |                    | Зашифрованный файл с помощью шифрования `NTFS` (`EFS`).                                                                        | Windows                                                 |
...
| `Offline`           | (нет)       |                    | Файл хранится вне локального хранилища (например, в архиве).                                                                   | Windows                                                 |
| `NotContentIndexed` | `I`         |                    | Файл не индексируется системой поиска Windows.                                                                                 | Windows                                                 |
