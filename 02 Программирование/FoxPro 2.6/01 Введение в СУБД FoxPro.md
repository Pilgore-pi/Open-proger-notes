...
> Любые идентификаторы переменных, функций, процедур и модулей не должны превышать 10 символов. Если идентификатор содержит больше 10 символов, то остальные символы, начиная с 11-го, будут проигнорированы. Позволяется использовать длинные идентификаторы для повышения читаемости кода.  
