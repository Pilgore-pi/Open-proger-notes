...
> Технология `P/Invoke` содержится в двух пространствах имен: `System` и `System.Runtime.InteropServices`
...
Оба предыдущих примера зависят от передаваемых параметров, и, в обоих случаях, параметры представлены управляемым типом. CLR делает свою работу по преобразованию управляемого типа в нативный автоматически.
