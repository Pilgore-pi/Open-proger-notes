...
Представляет сериализатор значений платформы "1С:Предприятие 8" в [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/XML|XML]] и [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/JSON|JSON]] на основе XDTO.
Имеет одно свойство **[[XDTO#ФабрикаXDTO|Фабрика]]** типа **`ФабрикаXDTO`**

| Метод                                               | Описание                                                                                                                            |
| --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `XMLЗначение(тип, xml)`                             | Преобразует строку [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/XML\|XML]] в значение с указанным типом                                                                        |
| `XMLСтрока(значение)`                               | Преобразует значение в строку [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/XML\|XML]]                                                                                          |
| `XMLТип(тип)`                                       | Получает тип данных [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/XML\|XML]], соответствующий указанному типу                                                                   |
| `XMLТипЗнч(значение)`                               | Получает тип данных [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/XML\|XML]], соовтетсвтующий типу указанного значения                                                          |
...
| `ЗаписатьJSON(записьJSON, значение, назначТипаXML)` | Записывает значения в формате [[02 Программирование/02 1С - Предприятие/02 Язык программирования/Сериализация/JSON\|JSON]]. `записьJSON`: объект, через который выполняется запись, `значение`: записываемое зн-е |
