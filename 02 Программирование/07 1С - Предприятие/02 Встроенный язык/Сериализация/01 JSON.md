...
- [02 XDTO](02%20XDTO.md)
- [[01 JSON#Тип ЗаписьJSON|Запись JSON]]

## Сериализация объекта конфигурации

К сожалению, в языке 1С нет универсального способа сериализации объекта любого типа в JSON, как в нормальнызыках (таких как, к примеру C#). По этой причине для каждого сложного типа нужно писать свой алгоритм сериализации, либо находить готовые решения, например, на GitHub.
