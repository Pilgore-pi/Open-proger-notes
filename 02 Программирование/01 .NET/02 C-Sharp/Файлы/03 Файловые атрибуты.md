...
| `Encrypted`         | (нет)       | 16384              | Зашифрованный файл с помощью шифрования `NTFS` (`EFS`)                                                                        | Windows                                                 |
| `Offline`           | (нет)       | 4096               | Файл находится в автономном режиме. Данные этого файла недоступны непосредственно                                             | Windows                                                 |
| `NotContentIndexed` | `I`         | 8192               | Файл не индексируется системой поиска Windows                                                                                 | Windows                                                 |
