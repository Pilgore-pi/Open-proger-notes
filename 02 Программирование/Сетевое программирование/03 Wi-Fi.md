...
Когда роутер посылает данные устройству, он ожидает подтверждения, так как кадр может не дойти до получателя по причине слабого сигнала, загруженности сети или коллизи
