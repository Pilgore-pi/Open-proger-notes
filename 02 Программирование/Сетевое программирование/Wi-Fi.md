...
Wi-Fi роутер выступает в роли посредника между провайдером связи и конечным устройством. Точка доступа также выступает в роли DHCP сервера. Для провайдера связи все устройства сети Wi-Fi имеют один и тот же IP-адрес. Но в рамках Wi-Fi сети для каждого устройства роутер определяет свой IP-адрес
