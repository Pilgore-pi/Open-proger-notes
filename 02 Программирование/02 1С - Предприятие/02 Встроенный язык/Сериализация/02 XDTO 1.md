...
Представляет сериализатор значений платформы "1С:Предприятие 8" в [[02 Программирование/02 1С - Предприятие/02 Встроенный язык/Сериализация/XML|XML]] и [[01 JSON|01 JSON]] на основе XDTO.
