**Как устроена фаловая система [[Файловые системы|можно узнать здесь]]**

В C\# работа с файлами осуществляется через безопасные файловые потоки:
...
и специальный файловый API `System.IO.File`, значительно упрощающий работу с файлами.
