...
1) Точка доступа отправляет управляющий **кадр** всем устройствам со след. информацией:
    - MAC-адрес
    - Название точки доступа
    - Данные о шифровании
2) Принимающее устройство выполняет **пассивное** или **активное** сканирование сети
