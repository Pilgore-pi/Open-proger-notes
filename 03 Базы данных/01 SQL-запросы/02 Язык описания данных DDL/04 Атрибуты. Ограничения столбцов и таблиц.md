...
Назад: [CREATE & DROP - Создание и удаление таблиц](03%20CREATE%20&%20DROP%20-%20Создание%20и%20удаление%20таблиц.md)

Далее: [ALTER TABLE - Изменение структуры таблицы](05%20ALTER%20TABLE%20-%20Изменение%20структуры%20таблицы.md)
...
Оператор `CONSTRAINT` вводит ограничение на сохраняемые данные для соблюдения целостности. Оператор позволяет в явном виде создать сложное именованное ограничение, к которому можно обращаться 
