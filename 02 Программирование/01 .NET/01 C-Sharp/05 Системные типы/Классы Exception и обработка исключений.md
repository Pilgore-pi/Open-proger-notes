...
| `StackTrace` | `string?`     | Строка, описывающая стек вызовов при возникновении ошибки. Если отслеживание стека невозможно, то возвращает `null`                            |
| `Data`       | `IDictionary` | Словарь с доп. информацией, которую поместил в исключение программист. По умолчанию словарь пуст. Интерфейс очень похож на `Dictionary<T,Key>` |
| ``           | ``            |                                                                                                                                                |
| ``           | ``            |                                                                                                                                                |
| ``           | ``            |                                                                                                                                                |
| ``           | ``            |                                                                                                                                                |
