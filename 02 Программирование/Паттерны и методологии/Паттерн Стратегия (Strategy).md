...
- Отсутствующая гибкость, нарушение принципа открытости-закрытости. При добавлении нового типа передвижения, нужно будет добавлять новое поле перечисления и 
