...
| ------------------ | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `class Expression` | `Expression` | представляет дерево выражений, описывающее запрос. Используется для анализа и построения запросов. Это свойство позволяет провайдеру запросов (например, Entity Framework) преобразовать запрос в SQL или другой формат |
|                    |              |                                                                                                                                                                                                                         |
