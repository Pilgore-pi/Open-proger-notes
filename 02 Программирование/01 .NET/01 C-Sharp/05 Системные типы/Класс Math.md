...
> **Класс Math** — API для выполнения сложных математических вычислений

> Существует класс полностью идентичный классу `Math` — `MathF`. Единственное отличие в том, что методы `MathF` возвращают `float`, а не `double`, как в `Math`
