...
Процедура ПопыткаCOMСоединения()
    ...
    попытка
        ...
        ОбщегоНазначения.СообщитьПользователю("COM-соединение успешно")
    ...
    исключение
        ...
        ОбщегоНазначения.СообщитьПользователю("Ошибка при создании COM-соединения!")
