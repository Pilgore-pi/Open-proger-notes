Атрибут — это метаданные, связанные с какой-либо сущностью кодаЭто классы, которые представляют собой метаданные для типов и их составляющих. Они нужны для взаимодействия программы и инструментов, работающих с программой (отладчик, среда разработки).
