...
Wi-Fi роутер выступает в роли посредника между провайдером связи и конечным устройством. Для провайдера связи все устройства сети Wi-Fi имеют один и тот же IP
