...
| `ClearCachedData()`             | ``            |                                                                                                                                                                                                                     |
| `Clone()`                       | ``            |                                                                                                                                                                                                                     |
| `GetConsoleFallbackUICulture()` | `CultureInfo` | Получает язык и региональные стандарты интерфейса пользователя, подходящие для консольных приложений, если при этом неприменим язык и региональные стандарты графического пользовательского интерфейса по умолчанию |
