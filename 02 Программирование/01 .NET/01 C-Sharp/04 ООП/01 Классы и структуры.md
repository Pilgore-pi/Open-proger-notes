...
| Деструктор                                                                            | да           | нет           | нет              |
| Индексатор                                                                            | да           | да            | да               |
| События                                                                               | да           | да            | да               |
| Перегрузки операторов                                                                 | да           | да            | нет              |
| Вложенные типы: `class`, `struct`, `interface`, `enum`, `delegate`, `event`, `record` | да           | да            | да               |
...
Свойства в C# позволяют управлять доступом к полям класса, предоставляя механизм для чтения и записи значений. Они выглядят как поля, но на самом деле одн это методы (геттеры и сеттеры), которые позволяют контролировать доступ к данным.
