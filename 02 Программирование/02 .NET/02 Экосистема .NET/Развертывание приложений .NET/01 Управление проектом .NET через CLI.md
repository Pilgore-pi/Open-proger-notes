...
cd "C:\Path\To\Project\Folder"
    ...
    PowerShell:
Set-Location "C:\Path\To\Project\Folder"

При использовании нескольких подключаемых сборок может генерироваться множество файлов:

dotnet publish -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true
dotnet publish -c Release -r win-x86 --self-contained true -p:PublishSingleFile=true
dotnet publish -c Debug -r win-x64 --self-contained true -p:PublishSingleFile=true
dotnet publish -c Debug -r win-x86 --self-contained true -p:PublishSingleFile=true

Принудительно упаковывает все линкуемые сборки и среду выполнения в один файл:
...
#Dotnet #Dotnet/Applications #API/Terminal
