...
| `[FileExtension]` | Свойство, поле, параметр (`string`) | Проверяет, соответствует ли поле данных одному из указанных расширений файлов. Если расширений не указано, используется значение по умолчанию: `"png,jpg,jpeg,gif"` |
