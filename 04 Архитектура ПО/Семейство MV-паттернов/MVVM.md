...
3) Для каждого представления создать свою модель представления (ViewModel), которая будет обеспечивать внутреннюю логику и использовать необходимые модели
