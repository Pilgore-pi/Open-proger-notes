...
## Структура типа [System.Globalization.CultureInfo](https://learn.microsoft.com/ru-ru/dotnet/api/system.globalization.cultureinfo?view=net-8.0#properties)
...
| `ThreeLetterISOLanguageName`     | `string`             | Возвращает трехбуквенный код ISO 639-2 для языка текущей культуры                                                                                                                                                                                                       |
| `ThreeLetterWindowsLanguageName` | `string`             | Возвращает трехбуквенный код для языка, определенный в формате Windows API                                                                                                                                                                                              |
| `TwoLetterISOLanguageName`       | `string`             | Возвращает двухбуквенный код ISO 639-1 или трехбуквенный код ISO 639-3 для языка текущей культуры                                                                                                                                                                       |
| `UseUserOverride`                | `bool`               | Использует ли текущая культура пользовательские параметры                                                                                                                                                                                                               |
