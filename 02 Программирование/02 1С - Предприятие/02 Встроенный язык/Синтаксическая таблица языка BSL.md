...
| -------------------------------------- | -------------------------- |
| `Если Тогда Иначе ИначеЕсли КонецЕсли` | `If Then Else ElsIf EndIf` |
| `Неопределено`                         | `Undefined`                |
| `Процедура КонецПроцедуры`             | `Procedure EndProcedure`   |
| `Функция КонецФункции`                 | `Function EndFunction`     |
| `ВызватьИсключение`                    | `Raise`                    |
| `Попытка Исключение КонецПопытки`      | `Try `                     |
| `Для каждого из цикл КонецЦикла`       | `For each in EndDo`        |
| `Пока цикл`                            | `While Do`                 |
| `Для По Цикл`                          | `For To Do`                |
| `Новый`                                | `New`                      |
| `Перем`                                | `var`                      |
| `Знач`                                 | `val`                      |
| `Выполнить`                            | `Execute`                  |
