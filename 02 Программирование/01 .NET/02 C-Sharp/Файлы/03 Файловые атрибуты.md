...
> API языка C\# предоставляет богатые средства для управления атрибутами файлов Windows, но работа с файловыми атрибутами в Linux или MacOS поддерживается не полностью
