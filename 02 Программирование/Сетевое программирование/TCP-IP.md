...
2) Транспортный — протоколы TCP (самый популярный), UDP, SCTP, DCCP и т. д. Данный уровень описывает, как и куда (какому процессу) должно прийти сообщение. Существует специальная система адресации сетевых сообщений
