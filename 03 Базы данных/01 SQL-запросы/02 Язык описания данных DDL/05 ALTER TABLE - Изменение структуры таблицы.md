...
Назад: [Атрибуты. Ограничения столбцов и таблиц](04%20Атрибуты.%20Ограничения%20столбцов%20и%20таблиц.md)

Далее: [Внешние ключи SQL](06%20Внешние%20ключи%20SQL.md)
