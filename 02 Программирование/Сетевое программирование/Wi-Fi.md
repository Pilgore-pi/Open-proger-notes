...
4. **Генерация сессионного ключа**. После успешной авторизации точка доступа генерирует сессионный ключ шифрования, после чего становится доступным обмен данными
