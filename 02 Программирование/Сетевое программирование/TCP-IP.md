...
| Флаг `FIN`                   | 1              | Указывает на то, что у передающей стороны больше нет данных для передачи. При попытке разрыва соединения отправитель и получатель отправляют сегм                 |
