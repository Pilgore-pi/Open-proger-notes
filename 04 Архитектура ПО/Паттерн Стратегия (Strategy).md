...
- Гибкость изменения функциональности программы
- Простота добавления новой логики (стратегии) — достаточно создать новый класс
- Изоляция логики
...
- Создание дополнительных абстракций негативно влияет на скорость выполнения программы (но этот недостаток покрывается большим упрощением разработки)
