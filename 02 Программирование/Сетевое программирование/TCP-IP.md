...
| ID пакета              | 16             | Идентификатор подпакета в рамках всего IP пакета. Пакеты данных могут разбиваться на подпакеты, если на **канальном уровне** есть ограничения на размер пакета и этому ограничению не удовлетворяет IP пакет              |
|                        |                |                                                                                                                                                                                                                           |
