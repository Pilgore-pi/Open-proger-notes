...
1. **`index.html`**: Этот файл обычно содержит контент домашней страницы, то есть текст и изображения, которые люди видят, когда они впервые попадают на сайт. Используя текстовый редактор, можно создать новый файл с именем `index.html` и сохранить его внутри папки `test-site`.
