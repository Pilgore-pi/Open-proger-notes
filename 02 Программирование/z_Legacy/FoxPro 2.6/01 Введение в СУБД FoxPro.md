...
В FoxPro используется язык программирования FoxBase, который является развитием языка XBase.
...
XBase и FoxPro сыграли важную роль в развитии программного обеспечения для управления базами данных. XBase заложил основу для многих последующих разработок, а FoxPro, благодаря своей производительности и функциональности, стал популярным инструментом для разработчиков баз данных в 1980-х и 1990-х годах.

Хотя сегодня FoxPro и XBase уже почти не используются, их наследие продолжает жить в современных СУБД и инструментах для работы с данными.
