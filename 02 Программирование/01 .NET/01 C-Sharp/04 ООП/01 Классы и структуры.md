...
| `private protected`  | Доступен внутри типа и его производных типов, но только в пределах текущей сборки. Производные типы из других сборок **не могут** получить доступ к этому члену. |
